...
"""
Создаём размер массива исходя из формулы: 2m + 1. Введите m: 10
Исходный массив - [87, 49, 96, 43, 85, 86, 25, 6, 6, 55, 76, 20, 99, 95, 42, 32, 22, 6, 81, 94, 42]
Реализация без сортировки - 49
Сортировка пирамидой - 49
Проверка встроенной функцией statistics.median - 49
Скорость моей реализации без сортировки:  0.0031525000000005576
Скорость сортировкой пирамидой:  0.009602499999999736
Скорость встроенной функции нахождения медианы:  0.00013580000000068537
"""
